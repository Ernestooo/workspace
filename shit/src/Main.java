...
public class Main {
	//Constantes que definem os comandos
	 ...
	 public static final String NOT_SAME_NUMBER = "All contacts have different phone numbers.";
	...
	private static void hasEqualPhones(ContactBook cBook) {
		if(cBook.samePhone())
			System.out.println(SAME_NUMBER);
		else
			System.out.println(NOT_SAME_NUMBER);
	}
